...
function initClient() {
  ...
  // var idaw = document.getElementById('gpcid').value + ".apps.googleusercontent.com"
  var idaw = "38796529945-7a6au1vu0ntr565rigmrb0bju1t5nu7k" + ".apps.googleusercontent.com"
  gapi.client.init({
      'clientId': idaw,
