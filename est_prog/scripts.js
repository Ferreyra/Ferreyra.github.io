...
function createPDF(event) { 
  ...
  iframe.setAttribute('style', 'position:absolute;top:0;right:0;height:100%; width:612px')
  ...
  pdf.rect(197, 682, 216, 70)

  pdf.setFontSize(10)
  pdf.text('Elaboró:', 216, 698)
  pdf.text('Ing. Fernando Monzón Arellano', 220, 730)
